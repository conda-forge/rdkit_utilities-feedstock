...
Once the `conda-forge` channel has been enabled, `rdkit_utilities` can be installed with:

```
conda install rdkit_utilities
```

It is possible to list all of the versions of `rdkit_utilities` available on your platform with:
